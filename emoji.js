...
function emoji(){}
	...
	emoji.replacement = function(idx, actual, wrapper){
		...
		emoji.init_env();
		if (emoji.replace_mode == 'unified'  && emoji.allow_native && emoji.data[idx][0]) return emoji.data[idx][0];
	...
	emoji.data = {
		...
		"0023-20e3":["\u0023\u20E3","\uE210","\uDBBA\uDC2C",["hash"],27,14],
		"0030-20e3":["\u0030\u20E3","\uE225","\uDBBA\uDC37",["zero"],27,15],
		"0031-20e3":["\u0031\u20E3","\uE21C","\uDBBA\uDC2E",["one"],27,16],
		"0032-20e3":["\u0032\u20E3","\uE21D","\uDBBA\uDC2F",["two"],27,17],
		"0033-20e3":["\u0033\u20E3","\uE21E","\uDBBA\uDC30",["three"],27,18],
		"0034-20e3":["\u0034\u20E3","\uE21F","\uDBBA\uDC31",["four"],27,19],
		"0035-20e3":["\u0035\u20E3","\uE220","\uDBBA\uDC32",["five"],27,20],
		"0036-20e3":["\u0036\u20E3","\uE221","\uDBBA\uDC33",["six"],27,21],
		"0037-20e3":["\u0037\u20E3","\uE222","\uDBBA\uDC34",["seven"],27,22],
		"0038-20e3":["\u0038\u20E3","\uE223","\uDBBA\uDC35",["eight"],27,23],
		"0039-20e3":["\u0039\u20E3","\uE224","\uDBBA\uDC36",["nine"],27,24],
