...
function emoji(){}
	...
	emoji.replace_emoticons = function(str){
		var colonized = emoji.replace_emoticons_with_colons(str);
		return emoji.replace_colons(colonized);
	};
	...
	emoji.replace_emoticons_with_colons = function(str){
		...
		var str_replaced = str.replace(emoji.rx_emoticons, function(m, $1, emoticon, offset){
			...
			var emoticon_has_open_paren = emoticon.indexOf('(') !== -1;
			var emoticon_has_close_paren = emoticon.indexOf(')') !== -1;

			/*
			 * Track paren-having emoticons for fixing later
			 */
			if (emoticon_has_open_paren || emoticon_has_close_paren) {
				if (emoticons_with_parens.indexOf(emoticon) == -1) {
			 ...
			 * This prevents matching "8)" inside "(before 8)"
			 */
			if (emoticon_has_close_paren && !emoticon_has_open_paren) {
