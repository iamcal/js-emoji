...
function emoji(){}
	...
	emoji.replace_emoticons = function(str){
		...
		return _replace_emoticons(str, function(m, $1, emoticon, $2) {
			var val = emoji.map.emoticons[emoticon];
			return val ? $1+emoji.replacement(val, emoticon)+$2 : m;
		});
	};
	...
	function _replace_emoticons(str, replace_fn) {
		var _prev_offset = 0;
		...
		var str_replaced = str.replace(emoji.rx_emoticons, function(m, $1, emoticon, offset){
			...
			return replace_fn(m, $1, emoticon, '');
		});
		...
		if (emoticons_with_parens.length) {
			...
			str_replaced = str_replaced.replace(parenthetical_rx, function(m, $1, emoticon, $2) {
				return replace_fn(m, $1, emoticon, $2);
			});
		}
