...
;(function() {
	...
	emoji.prototype.replacement = function(idx, actual, wrapper, variation){
		...
		self.init_env();
		if (self.replace_mode == 'unified'  && self.allow_native && self.data[idx][0][0]) return self.format_native(self.data[idx][0][0]) + extra;
		if (self.replace_mode == 'softbank' && self.allow_native && self.data[idx][1]   ) return self.format_native(self.data[idx][1]   ) + extra;
		if (self.replace_mode == 'google'   && self.allow_native && self.data[idx][2]   ) return self.format_native(self.data[idx][2]   ) + extra;
	...
	/** @private */
	emoji.prototype.format_native = function(native){
		if (self.wrap_native){
